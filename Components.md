...
| [**Neo-reGeorg**](https://github.com/L-codes/Neo-reGeorg) | Advanced ASPX/PHP/JSP web shell. | **Silk Typhoon** (MURKY PANDA) | Deployed on internet-facing appliances to establish initial access and persistence. |
| [**Garble**](https://github.com/burrowers/garble) | Go code obfuscator. | **Silk Typhoon** (MURKY PANDA) | Used to obfuscate the *CloudedHope* RAT to hinder static analysis and detection. |
